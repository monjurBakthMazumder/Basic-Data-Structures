...
| ---------------------------------------- | ------------------------------------------------------------------------------------- |
| **Day 01: Time and Space Complexity**    | Understanding Big O notation, efficiency, and performance analysis.                   |
| **Day 02: STL Vector**                   | Introduction to the C++ Standard Template Library (STL) and dynamic arrays.           |
| **Day 03: Prefix Sum and Binary Search** | Efficient range queries and logarithmic search techniques.                            |
| **Day 04 - 06: Singly Linked List**      | Implementation, head/tail operations, and advanced node manipulation.                 |
| **Day 07: Test 01**                      | First assessment covering complexity, vectors, and basic lists.                       |
| **Day 08 - 10: Advanced Lists**          | Doubly Linked Lists, STL list usage, cycle detection, and list-based problem solving. |
| **Day 11 - 13: Stacks and Queues**       | Implementation, STL integration, and solving problems with LIFO/FIFO structures.      |
